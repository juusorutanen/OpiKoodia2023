...
createForm = () => {
    ...
    root.setAttribute("class", "mx-auto col-10 col-md-8 col-lg-6")

let h1 = document.createElement('h1');
h1.innerText = "Send form";
h1.setAttribute("class", "display-1 text-center")
root.appendChild(h1);
    ...
    submitButton.setAttribute("class", "btn btn-success mt-3");
